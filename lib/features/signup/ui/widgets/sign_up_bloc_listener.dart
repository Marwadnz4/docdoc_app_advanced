...
import 'package:docdoc_app/features/signup/logic/sign_up_state.dart';
...
class SignUpBlocListener extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocListener<SignupCubit, SignUpState>(
      listenWhen: (previous, current) => current is SignUpLoading || current is SignUpError || current is SignUpSuccess,
